...
namespace Com.Latipium.Defaults.Player {
	...
	public class PlayerObject : AbstractLatipiumObject {
        ...
        private Func<Com.Latipium.Core.Tuple<float, float, float>, Com.Latipium.Core.Tuple<float, float, float>> Position;
		...
		internal LatipiumObject Object {
			...
			set {
                ...
                Position = _Object.GetFunction<Com.Latipium.Core.Tuple<float, float, float>, Com.Latipium.Core.Tuple<float, float, float>>("Position");
				if ( Position != null ) {
                    Position(new Com.Latipium.Core.Tuple<float, float, float>(0, -5, -5));
				}
